...
<body class="bg-gray-100 font-jost">
   ...
   @include('frontend.body.mobilesearch')

    <!-- Mobile/Tablet View -->
  <!-- Mobile/Tablet View -->
    @include('frontend.body.mobiletopmenu')
    <!-- Mobile Side Menu -->

    @include('frontend.body.mobiletopsidebar')
    ...
    @include('frontend.body.mobilebuttommenu')

    <!-- Mobile Category Menu -->
    @include('frontend.body.mobilebuttomsidebar')
    ...
    <script src="{{asset('frontend/productdetails.js')}}"></script>
